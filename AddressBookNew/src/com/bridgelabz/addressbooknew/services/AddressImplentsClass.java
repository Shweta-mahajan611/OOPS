...
public class AddressImplentsClass implements Address
{
	 ...
	 * @return
	 */
	public ArrayList<Person> searchByPhoneNo() throws IOException
	{
		System.out.println("Enter phone no :");
	...
	public void sortByLastName() 
	{
			...
			List<Person> sortedlist = personlist.stream().sorted(Comparator.comparing(Person::getLastName)).collect(Collectors.toList());
